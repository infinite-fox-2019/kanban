<template>
  <div class="d-flex justify-content-center flex-wrap">
      <b-col sm="8" md="4">
          ...
          <b-card id="ToDoHead" header="ToDo" header-class="text-center">
      ...
      <b-col sm="8" md="4">
        <div id="OnProgress" class="ml-1 mt-1">
           <b-card id="OnProgressHead" header="OnProgress" header-class="text-center">
      ...
      <b-col sm="8" md="4">
        <div id="Done" class="ml-1 mt-1">
          <b-card id="DoneHead" header="Done" header-class="text-center">
...
export default {
  ...
  //     ToDoList () {
  //       this.ToDo = []
  //       db.collection('lists').where('status', '==', 'ToDo')
  //         .onSnapshot(querySnapshot => {
  //           // console.log(querySnapshot)
  //           querySnapshot.forEach(doc => {
  //             console.log(doc)
  //             this.ToDo.unshift(doc.data())
  //           })
  //         })
  //     },
  //     OnProgressList () {
  //       this.OnProgressList = []
  //       db.collection('lists').where('status', '==', 'OnProgress')
  //         .onSnapshot(querySnapshot => {
  //           // console.log(querySnapshot)
  //           querySnapshot.forEach(doc => {
  //             console.log(doc)
  //             this.OnProgressList.unshift(doc.data())
  //           })
  //         })
  //     },
  //     DoneList () {
  //       this.DoneList = []
  //       db.collection('lists').where('status', '==', 'Done')
  //         .onSnapshot(querySnapshot => {
  //           // console.log(querySnapshot)
  //           querySnapshot.forEach(doc => {
  //             console.log(doc)
  //             this.DoneList.unshift(doc.data())
  //           })
  //         })
  //     }
  //   },
